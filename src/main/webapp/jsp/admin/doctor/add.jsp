                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item active">
                            <a class="nav-link"
                                href="${pageContext.request.contextPath}/jsp/admin/doctor/index.jsp">医生管理 <span
        ...
        <div class="container mt-5">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="${pageContext.request.contextPath}/admin/doctor?action=add" method="post">
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="avatar" name="avatar" placeholder="医生头像URL">
                            </div>
                        </div>
                        <div class="mb-3">
                        ...
                        <a href="${pageContext.request.contextPath}/admin/doctor?action=list"
