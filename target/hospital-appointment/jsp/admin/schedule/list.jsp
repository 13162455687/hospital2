            ...
            <div class="container mt-5">
                ...
                <div class="mb-3">
                    <a href="${pageContext.request.contextPath}/admin/schedule?action=add"
                        class="btn btn-primary">添加排班</a>
                </div>

                <!-- 排班列表表格 -->
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">排班列表</h5>
                            ...
                            <tbody>
                                <c:forEach var="schedule" items="${schedules}">
                                    <tr>
                                        ...
                                        <td>${schedule.maxNum}</td>
                                        <td>${schedule.currentNum}</td>
                                        <td>
                                            <c:choose>
                                        ...
                                        <td>
                                            <a href="${pageContext.request.contextPath}/admin/schedule?action=edit&id=${schedule.id}"
                                                class="btn btn-sm btn-primary mr-2">编辑</a>
                                            <a href="${pageContext.request.contextPath}/admin/schedule?action=delete&id=${schedule.id}"
                                                class="btn btn-sm btn-danger"
                                                onclick="return confirm('确定要删除该排班吗？');">删除</a>
                                        </td>
                                    </tr>
                                </c:forEach>
                            </tbody>
