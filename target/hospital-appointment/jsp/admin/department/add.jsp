...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
    ...
    <body>
        ...
        <div class="container mt-5">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="${pageContext.request.contextPath}/admin/department?action=add" method="post">
